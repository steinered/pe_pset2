...
stargazer(model, title = "Results", type = "html")

# summary(lm(formula, data = ftp_merged))
...
The coefficient of TLyes is 0.389, which is positive but not statistically significant. 
