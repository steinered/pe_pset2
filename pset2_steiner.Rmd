...
stargazer(lm_afdc, lm_fs, lm_emp, type = "html", title = "OLS regression on TLyes by age group", column.labels = c("Months AFDC", "Months Food Stamps", "Quarters Employed"), covariate.labels = c("TLyes", "Group 1", "Group 2", "Group 3", "Trt x Group 1", "Trt x Group 2", "Trt x Group 3"))
